...
| `abs` | math | `abs` | gap (must) | gap (should) |
| `min` | math | `least` | gap (should) | — |
| `max` | math | `greatest` | gap (should) | — |
| `floor` | math | `ground` | gap (must) | — |
| `ceil` | math | `elevate` | gap (should) | — |
| `round` | math | `nearby` | gap (should) | — |
| `sqrt` | math | `root` | gap (must) | — |
| `pow` | math | `pow` | gap (must) | — |
| `sin` | math | `sin` | gap (must) | — |
| `cos` | math | `cos` | gap (must) | — |
| `exp` | math | `exp` | gap (must) | — |
| `log` | math | `ln` | gap (must) | — |
...
| `lambda` | syntax | gap (must) | gap (should) | — |
